...
#cl = LineClient()                                                                                        cl = LineClient(authToken='EQSJietfDElAjAVpIwQa.d30TuBRrKxkUIL7Ssvl9IG.ssry1aT7CesFtQ14ymQDChFxtxBYkXpMZ9N
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EQiA13PNxiCTNh75O1A7.3LbSS3gMZkmJcia1DpatTW.U1L2SHd3vneRV3SHNfd7Dxx3Q02vQeVpaSUki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EQIflSCaxl4p1QZiWcl4.nSmEBo2OA24v8Q778zYtna.Dklyi2pVOAQp8HubPLbbzGwY70/3iA68vi/
kk.log("Auth Token : " + str(kk.authToken))                                                               channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EQ9VJiz5GpWUFJdviPse.A2H/ZRmW6eQ1XZWcbZhkpG.5d84gbNKvxYL8AxSkS9OShiZFT6USIlKv8E
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kb = LineClient(authToken='EQWmjDH2nO3VNWeVyLU7.I0rvRK0vLwDVYo3lblLenW.EwCX4cK1gaBMfotpssMeignWTWU9tQy4Id8
kb.log("Auth Token : " + str(kb.authToken))                                                               channel4 = LineChannel(kb)
kb.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='EQKIjGH4L9DsabBlf31e.i/2F0kr48rlqcShBagUp+G.bxkAJq9rjzpU4DcnS6gX9gOUKWUPCnYZU5B
...
admin = ["u0f7d2d51bad19172ae8a5eec4952fd8a","u4c5a38b58b22cd7c1c900e99936f61b1","u43e28ad57af62bfd6d90a7>
staff = ["u0f7d2d51bad19172ae8a5eec4952fd8a"]
...
wait = {
    ...
    "unsend":True,
"mention":"Cie.......ɴɢɪɴᴛɪᴘ ʏᴀ\nSini masuk kak.. gabung disini sama gank gibah\nJangan malu malu kak>    
"Respontag":"Gakusah ngetag, kalau kangen pm aja",                                                       
"welcome":"===SELAMAT DATANG DI ROOM===\n            ~Budayakan CEK NOTE~\nSemoga ketemu jodohnya yah>
    "leave":"Slamat tinggal kk baper\nsmoga ketemu kembali di tikungan lampu lampu merah",                    
    "comment":" ──────┅❇͜͡❇͜͡☆͜͡❇͜͡❇┅──────\nᴼᴾᴱᴺ ᴼᴿᴰᴱᴿ\n────────┅┅───────\n➣ꜱᴇʟꜰʙᴏᴛ ᴏɴʟʏ\n➣ꜱᴇʟꜰʙᴏᴛ + ᴀꜱɪꜱᴛ\n➣1 ᴀ>   
    "message":"Terimɑ Kɑsih yɑ....\nUdɑh Menɑmbɑhkɑn Sɑyɑ Sebɑgɑi Temɑn ɑndɑ.\nSemogɑ Kitɑ Bisɑ Jɑlin Sil>
}
read = {
    "readPoint":{},
    "readMember":{},
